...
@app.route("/admin/csv_crear_backup")
...
@app.route("/admin/csv_leer", methods=["POST"])
def adm_csv_leer():
    if 'nombre' not in session:
        if session["rol"] != "administrador":
            return redirect("/login")
...
@app.route("/admin/json_crear_backup")
...
@app.route("/admin/json_leer", methods=["POST"])
...
def show_all_user_admin():
    ...
    return render_template("admin/users/showAll.html",usuarios=usuarios)
@app.route("/admin/users/form-create")
def adm_form_create_user():
    ...
    if 'nombre' not in session:
        if session["rol"] != "administrador":
            return redirect("/login")
    return render_template("admin/users/form-create.html")
...
@app.route("/admin/users/form-update", methods=["POST", "GET"])
def adm_form_update_user():
    ...
    usuario=usuarios[0]
    print(usuario)
    return render_template("admin/users/form-update.html",usuario=usuario)
...
#                           Sports
#####################################################################
@app.route("/admin/sports/showAll")
def show_all_sports_admin():
    ...
    deportes=database.obtener_todos_los_deportes()
    return render_template("admin/sports/showAll.html",deportes=deportes)
@app.route("/admin/sports/form-create")
def adm_form_create_sport():
    if 'nombre' not in session:
        if session["rol"] != "administrador":
            return redirect("/login")
    return render_template("admin/sports/form-create.html")
...
@app.route("/admin/sports/form-update", methods=["POST", "GET"])
def adm_form_update_sport():
    ...
    return render_template("admin/sports/form-update.html",deporte=deporte_formateado)
@app.route("/admin/sports/update", methods=["POST"])
def adm_update_sport():
    ...
    return redirect(url_for("show_all_sports_admin"))
@app.route("/admin/sports/delete", methods=["post"])
...
#                           User-sports
#####################################################################
@app.route("/admin/user_sports/showAll")
def show_all_user_sports_admin():
    ...
    return render_template("admin/user_sports/showAll.html",deportes_usuario=deportes_usuario)
@app.route("/admin/user_sports/form-create")
def adm_form_create_user_sport():
    ...
    deportes=database.obtener_todos_los_deportes()
    usuarios=database.obtener_todos_los_usuarios()
    return render_template("admin/user_sports/form-create.html", deportes=deportes, usuarios=usuarios)
@app.route("/admin/user_sports/create", methods=["POST"])
...
@app.route("/admin/user_sports/form-update", methods=["POST", "GET"])
def adm_form_update_user_sport():
    ...
    return render_template("admin/user_sports/form-update.html", deportes=deportes, usuarios=usuarios, deporte=deporte, usuario=usuario)
@app.route("/admin/user_sports/update", methods=["POST"])
def adm_update_user_sport():
    ...
    try:
        ...
        return redirect(url_for("adm_form_update_user_sport", id_deporte=id_deporte_viejo, id_usuario=id_usuario_viejo))
    return redirect(url_for("show_all_user_sports_admin"))
@app.route("/admin/user_sports/delete", methods=["post"])
...
#                   forbidden days
#####################################################################
@app.route("/admin/forbidden_days/showAll")
def show_all_forbidden_days_admin():
    if 'nombre' not in session:
        if session["rol"] != "administrador":
            return redirect("/login")
    dias_prohibidos=database.obtener_todos_los_dias_prohibidos()
    return render_template("admin/forbidden_days/showAll.html",dias_prohibidos=dias_prohibidos)

@app.route("/admin/forbidden_days/form-create")
def adm_form_create_forbidden_days():
    ...
    deportes=database.obtener_todos_los_deportes()
    return render_template("admin/forbidden_days/form-create.html", deportes=deportes)
@app.route("/admin/forbidden_days/create", methods=["POST"])
...
@app.route("/admin/forbidden_days/form-update", methods=["POST", "GET"])
def adm_form_update_forbidden_days():
    ...
    return render_template("admin/forbidden_days/form-update.html",dia_prohibido=dia_prohibido, deportes=deportes)
    
@app.route("/admin/forbidden_days/update", methods=["POST"])
def adm_update_forbidden_days():
    ...
    return redirect(url_for("show_all_forbidden_days_admin"))
@app.route("/admin/forbidden_days/delete", methods=["post"])
